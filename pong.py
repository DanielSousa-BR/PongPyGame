...
def ball_start():
	...
	if current_time - score_time < 700:
		...
		screen.blit(number_three,(screen_width//2 - 5, screen_height//2))
	if 700 < current_time - score_time < 1400:
		number_two = basic_font.render("2",False,light_grey)
		screen.blit(number_two,(screen_width//2 - 5, screen_height//2))
	if 1400 < current_time - score_time < 2100:
		number_one = basic_font.render("1",False,light_grey)
		screen.blit(number_one,(screen_width//2 - 5, screen_height//2))
